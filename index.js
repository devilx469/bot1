...
const token = '6681962563:AAEcPAuDs97yggOPMXJ5PP2l_yrwJ-Pbgrc';
...
function logActivity(msg) {
  ...
  console.log(`• 1470983554: ${user.id}`);
  console.log(`• @Devilx4101: ${user.username || 'Tidak ada'}`);
  console.log(`• 1470983554: ${chat.id}`);
